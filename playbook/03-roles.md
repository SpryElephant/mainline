...
3. **Everything you find that is repeatable goes into the suite.** If you have run the same manual
   ...
   **The suite is yours and it is binding.** You decide what is in it; `quality-gate` dimension 6
...
**Skills:** `deployment-pipeline`, `observability`, `local-stack`, `security-gate`.

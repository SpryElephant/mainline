...
The checklist is **`review-station` step 5**. Read it there and verify each line.
...
- **`quality-gate` green on the merge commit**, not just on the branch.
...
`improvement-loop` entry rather than a fourth waiver.

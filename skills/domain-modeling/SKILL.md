...
them to `requirement-workflow` as required scenarios. A missing scenario here is a coverage gap the
...
(1) and (2) feed the architecture rules in `quality-gate` (dimension 2); (2) and (3) feed the build
steps in `development-workflow`.

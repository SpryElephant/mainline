...
Upstream: https://github.com/nemo-ufes/Tonto/blob/main/examples/Guidances/.cursor/rules/tonto-cardinality-guidance.mdc
...
## Examples from a Healthcare Domain

Practical examples using a `healthcare` package:
...
### Example 4: Company and Employee

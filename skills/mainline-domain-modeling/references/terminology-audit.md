...
Source: `tonto-cli add-skill . --target claude` at tonto-cli v0.4.12 (2026-08-03),
file .claude/skills/tonto-ontology/references/terminology.md — upstream verbatim.
See references/ATTRIBUTION.md for provenance and the refresh procedure.
-->
